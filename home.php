...
if (isset($_SESSION['user_uid'])) {
  ...
  if ($result['user_type'] == "admin") {
    ...
    if(sizeof($eventList) > 0)
    {
      ...
      //reset a user pw form
      echo("<div id='reset-user-pw' class='event-list p-2' style='display: none;'>");
      echo("<h2 class='dash-header'>Reset user password: </h2><hr>");
      echo("<div id='reset-user-pw-section' class='container'>");
      echo('
      <form id="reset-form">
      <p class="form-message"></p>
      <ul class="reset-list">
