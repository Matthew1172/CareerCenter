...
if (isset($_POST['submit'])) {
  ...
  $work_start = $_POST['start_date'] . " " . $_POST['start_time'];
  $work_end = $_POST['end_date'] . " " . $_POST['end_time'];
...
<script>
$("#work-title, #work-desc, #work-loc, #work-start-date, #work-end-date, #work-start-time, #work-end-time").removeClass("input-error");
...
if (errorEmpty == true)
{
  $("#work-title, #work-desc, #work-loc, #work-start-date, #work-end-date, #work-start-time, #work-end-time").addClass("input-error");
}
...
{
  $("#work-title, #work-desc, #work-loc, #work-start-date, #work-end-date, #work-start-time, #work-end-time").val("");
