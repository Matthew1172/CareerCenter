    ...
    elseif ($result['user_type'] == "employer")
    {
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class=""><button class="btn-outline-secondary btn nav-link job-list-btn">Your Jobs</button></li>
                    <li class=""><button class="btn-outline-secondary btn nav-link post-job-btn">Post Job</button></li>
